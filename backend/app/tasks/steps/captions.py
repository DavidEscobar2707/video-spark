...
from app.services.caption_presets import get_caption_preset_spec, normalize_caption_preset
...
def _build_ass(chunks: list[CaptionChunk], *, position: str | None, preset: str | None) -> str:
    alignment = _alignment_position(position)
    preset_spec = get_caption_preset_spec(preset)
...
Style: Karaoke,{preset_spec["fontName"]},{preset_spec["fontSize"]},{preset_spec["primaryColour"]},{preset_spec["secondaryColour"]},{preset_spec["outlineColour"]},{preset_spec["backColour"]},{preset_spec["bold"]},0,0,0,100,100,{preset_spec["spacing"]},0,1,{preset_spec["outline"]},{preset_spec["shadow"]},{alignment},60,60,{preset_spec["marginV"]},1
...
async def build_captions(
    ...
    try:
        preset = normalize_caption_preset(captions_config.get("preset"))
    ...
    ass_path.write_text(
        _build_ass(chunks, position=captions_config.get("position"), preset=preset),
        encoding="utf-8",
    )
